...
const FollowUpManager: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
                    ...
                    <td className="p-4">
                      <div className="flex gap-2">
                        {followUp.status === 'pending' && (
                          <Button size="sm" variant="outline" onClick={() => markAsCompleted(followUp.id)} className="text-green-600 hover:text-green-700">
      ...
      {/* DIALOGS */}
      {/* View, Edit, History Dialogs here - use your original dialog code */}
